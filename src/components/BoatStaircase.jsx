...
const STEPS = [
  {
    label: 'Automatisierung', sub: 'Nutzung durch KI',
    color: '#C4A0DC',
    img: require('@site/static/img/boat_4.png').default,
  },
  {
    label: 'Kollaboration', sub: 'wirkungsorientiert publizieren',
    color: '#8C3DC4',
    img: require('@site/static/img/boat_3.png').default,
  },
  {
    label: 'Zugang', sub: 'open by default',
    color: '#6B2899',
    img: require('@site/static/img/boat_2.png').default,
  },
  {
    label: 'Transparenz', sub: 'Öffentlichkeitsprinzip',
    color: '#4A1472',
