...
- [Bereitstellen, Publizieren und Aktualisieren offener Behördendaten](#...)
   01 [Daten als einfach nutzbare, maschinenlesbare 'Ressourcen' aufbereiten](#...)
   02 ['Ressourcen' offen zugänglich bereitstellen](#...)
   03 [Daten als 'Datensätze' erfassen und mit Metadaten beschreiben](#...)
   04 [Erstmalig erfasste 'Datensätze' zur Publikation freigeben](#...)
   05 [Publizierte 'Datensätze' und 'Ressourcen' aktualisieren](#...)
   06 [Aktualisierung von 'Datensätzen' und 'Ressourcen' abbrechen](#...)
