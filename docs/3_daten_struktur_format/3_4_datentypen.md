...
| **Uhrzeit** | [ISO 8601](https://www.w3.org/TR/NOTE-datetime): entweder kombiniert `YYYY-MM-DDThh:mm:ss` oder in zwei separaten Spalten `datum` + `uhrzeit`. `T` oder Leerzeichen als Trennzeichen zwischen Datum und Uhrzeit sind erlaubt. Lokalzeit wenn möglich nutzen (CET im Winter, CEST im Sommer). Ist die Zeitzone nicht eindeutig ableitbar, auf UTC normalisieren, mit `Z` kennzeichnen und in den Metadaten vermerken. | `2021-12-24T19:20:30`, `datum: 2021-12-24 uhrzeit: 19:20:30` | `2021-12-24T19:20:30+01:00`, `24.12.2021 19:20` |
