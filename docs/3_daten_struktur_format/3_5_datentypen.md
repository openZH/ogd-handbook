...
| **Uhrzeit**     | [ISO 8601](https://www.w3.org/TR/NOTE-datetime): entweder kombiniert `YYYY-MM-DDThh:mm:ss` oder in zwei separaten Spalten `datum` + `uhrzeit`. `T` oder Leerzeichen als Trennzeichen zwischen Datum und Uhrzeit verwenden. <br/> Lokalzeit wenn möglich verwenden (CET im Winter, CEST im Sommer). Ist die Zeitzone nicht eindeutig ableitbar, auf UTC normalisieren, mit `Z` kennzeichnen und in den Metadaten vermerken. | `2021-12-24T19:20:30`,`2021-12-24 19:20:30` | `24.12.2021 19:20`                       |
| **Boolean**     | Ja/Nein-Werte sollen als `true` / `false` angegeben werden                                                                                                                                                                                                                                                                                                                                                                 | `true`                                      | `1/0`, `ja/nein`, `x`, `t/f`             |
| **Koordinaten** | [WGS84](https://www.w3.org/TR/sdw-bp/#CRS-background) (empfohlen) oder LV95 (CH1903+): `breitengrad_wgs84` ,`laengengrad_wgs84`                                                                                                                                                                                                                                                                                                    | `47.3786314` ,`8.54110776`                     | -                                        |
