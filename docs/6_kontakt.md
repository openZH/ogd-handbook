...
<div className="team-grid">
  <div className="team-member">
    <img src={require('/img/avatar_ls.webp').default} className="team-avatar" />
    <p><strong>Laure Stadler</strong><br/>Lead FK OGD<br/><a href="mailto:info@open.zh.ch">info@open.zh.ch</a></p>
  </div>
  <div className="team-member">
    <img src={require('/img/avatar_pb.webp').default} className="team-avatar" />
    <p><strong>Philipp Bosch</strong><br/>Stv. Lead FK OGD, Data Community</p>
  </div>
  <div className="team-member">
    <img src={require('/img/avatar_te.webp').default} className="team-avatar" />
