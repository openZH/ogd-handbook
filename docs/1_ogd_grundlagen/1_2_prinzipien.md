...
<CardGrid cols={3}>
<Card icon={require('@site/static/img/odc_principles_1.png').default} title="1. Open by Default">
...
<Card icon={require('@site/static/img/odc_principles_2.png').default} title="2. Aktualität und Vollständigkeit">
...
<Card icon={require('@site/static/img/odc_principles_3.png').default} title="3. Zugänglich und nutzbar">
...
<Card icon={require('@site/static/img/odc_principles_4.png').default} title="4. Vergleichbarkeit und Interoperabilität">
...
<Card icon={require('@site/static/img/odc_principles_5.png').default} title="5. Transparenz und Beteiligung">
...
<Card icon={require('@site/static/img/odc_principles_6.png').default} title="6. Innovation und gesellschaftlicher Nutzen">
